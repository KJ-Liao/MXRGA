...
for t=1:size(Sample,1) % Example: t=1
    ...
    try
        ...
        PDB=pdbread(['/home/juju/Desktop/SingleChain_PDB_2022-05-27/', PDB_ID,'.pdb']);
        ...
        Ply_file = fopen(['/home/juju/Desktop/3D Zernike Descriptors/Kihara_3D Surfer/Qualified_Sample_data_9120/',PDB_ID,'/',PDB_ID, '.ply']);
        while(1)
            line=fgetl(Ply_file);
