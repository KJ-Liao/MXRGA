...
Dimer_Sample=Sample;
load('/home/juju/Desktop/MXRGA_Sample Log/4. MXRGA Crystal Packing/P41212_Sample/7. Statistics/4. SurfOrca/SurfOrca_RMSD_Statistic.mat')
SurfOrca_Sample=Sample;

clearvars -except Result Dimer_Sample SurfOrca_Sample

% Load Statistics of MXRGA Simulated Xtal
load('MXRGA_RMSD_Statistic.mat')

Sample(1).C2_RMSD95=[];
Sample(1).C4_RMSD95=[];
Sample(1).Tetramer_RMSD95=[];
Sample(1).Rank=[];
for r=1:size(Sample,2)
    ...
    Sample(r).C4_RMSD95=SurfOrca_Sample(r).C4_RMSD95;
    Sample(r).Tetramer_RMSD95=SurfOrca_Sample(r).RMSD_95;
end
...
Merged_Result = struct('ID',{Sample.ID},...
                       ...
                       'Tetramer_RMSD95',{Sample.Tetramer_RMSD95},...
...
SurfOrca_Ind=[Merged_Result.Tetramer_RMSD95]<=8;
