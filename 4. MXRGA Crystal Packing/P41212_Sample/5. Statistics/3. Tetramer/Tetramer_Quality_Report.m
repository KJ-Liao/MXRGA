...
load('Tetramer_RMSD_Statistic.mat')
...
[size(Result,2)-sum(Table(:,c)>=0.23&Table(:,c)<0.49)-sum(Table(:,c)>=0.49&Table(:,c)<0.8)-sum(Table(:,c)>0.8),...
 (size(Result,2)-sum(Table(:,c)>=0.23&Table(:,c)<0.49)-sum(Table(:,c)>=0.49&Table(:,c)<0.8)-sum(Table(:,c)>0.8))/size(Result,2);
 sum(Table(:,c)>=0.23&Table(:,c)<0.49),sum(Table(:,c)>=0.23&Table(:,c)<0.49)/size(Result,2);
 sum(Table(:,c)>=0.49&Table(:,c)<0.8),sum(Table(:,c)>=0.49&Table(:,c)<0.8)/size(Result,2);
 sum(Table(:,c)>0.8),sum(Table(:,c)>0.8)/size(Result,2);
 sum(Table(:,c)>=0.23&Table(:,c)<0.49)+sum(Table(:,c)>=0.49&Table(:,c)<0.8)+sum(Table(:,c)>0.8),...
 (sum(Table(:,c)>=0.23&Table(:,c)<0.49)+sum(Table(:,c)>=0.49&Table(:,c)<0.8)+sum(Table(:,c)>0.8))/size(Result,2)]
