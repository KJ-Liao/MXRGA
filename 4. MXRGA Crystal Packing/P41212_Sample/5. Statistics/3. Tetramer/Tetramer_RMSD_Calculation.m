...
%%%% RMSD95 Calculation
% Path Setting
Path='/home/juju/Desktop/MXRGA_Sample Log/4. MXRGA Crystal Packing/P41212_Sample/5. C4.DIPER_P41212/3. TopRank_300_Pose/';
...
for r=1:size(Sum_Table,2)
    ...
    % Xtal
    Xtal_Filename=[Path, lower(Sum_Table(r).ID(1:4)), '/', Sum_Table(r).ID, '_Ans.pdb'];
    ...
    % AlphaFold2
    AF_Filename=[Path, lower(Sum_Table(r).ID(1:4)), '/', Sum_Table(r).ID, '_C2C4.pdb'];
...
save('Tetramer_RMSD_Statistic.mat','Sample');